    ...
    sections = {
        "TECHNICAL REPORT": [
            (
                ...
                "report/EEEM068_LSA_Melanoma_Final_Report_Revised.pdf; main_model_results.csv",
                "complete",
                "Final report and frozen evidence are present",
            ),
            (
                "Introduction",
                "Clinical classification context, imbalance, patient grouping, and project aims",
                "final report; outputs/dataset_summary.json; report/methodology_notes.md",
                "complete",
                "Claims remain scoped to internal validation",
            ),
            (
                "Literature review",
                "Relevant melanoma classification, transfer learning, imbalance, metadata fusion, and explainability literature",
                "report/EEEM068_LSA_Melanoma_Final_Report_Revised.pdf",
                "complete",
                "Literature synthesis is contained in the submitted report",
            ),
            (
                "Methodology",
                "Patient-aware split, preprocessing, models, loss, optimization, evaluation, bootstrap, and Grad-CAM",
                "final report; deep_model_protocol.csv; hyperparameter_selection.csv; src/; configs/",
                "complete",
                "Fold 0 is validation, not an independent test set",
            ),
            (
                "Experiments/results",
                "Main metrics, training behaviour, comparisons, thresholds, subgroups, failures, and uncertainty",
                "final report; outputs/final/tables/; outputs/final/figures/; frozen predictions",
                "complete",
                "Comparison boundaries and threshold 0.5 are retained",
            ),
            (
                "Conclusion/future work",
                "Evidence-bounded conclusions and external/nested-validation recommendations",
                "final report; comparison_boundaries.json; bootstrap_summary.csv; integrity_summary.csv",
                "complete",
                "No clinical or external-validation claim",
            ),
            (
                "Creativity",
                ...
                "complete",
                "No individual-metadata causality claim",
            ),
        ],
        "PROJECT-SPECIFIC OBSERVATIONS": [
            (
                ...
                "documented",
                "No grid, random, or Bayesian search was performed",
            ),
            (
                "Training behaviour",
                ...
                "complete",
                "Checkpoint selection and effective duration are distinguished",
            ),
            (
                "Performance metrics",
                ...
                "complete",
                "Average Precision is the final-facing term",
            ),
            (
                "Confusion matrices",
                ...
                "complete",
                "Threshold 0.5 is the primary common operating point",
            ),
            (
                "Visualisations",
                "Training, ROC/PR, threshold, subgroup, bootstrap, failure, and Grad-CAM evidence",
                "outputs/final/figures/; outputs/figures/; outputs/analysis/",
                "complete",
                "Approved PNG/PDF publication assets are present",
            ),
        ],
        "FUNCTIONALITY": [
            (
                ...
                "External source JPEGs are intentionally not tracked",
            ),
            (
                ...
                "implemented_verified",
                "Augmentation is training-only; validation is deterministic",
            ),
            (
                "Patient-aware split",
            ...
            (
                ...
                "implemented_verified",
                "H0/H1 to B0 is historical, not a controlled comparison",
            ),
            (
                "Training",
                ...
                "implemented_verified",
                "Full retraining requires the external dataset and compute",
            ),
            (
                "Evaluation",
                ...
                "implemented_verified",
                "AP and validation terminology verified",
            ),
            (
                ...
                "implemented_verified",
                "Grad-CAM does not explain the metadata branch",
            ),
            (
                "Analysis pipeline",
                ...
                "implemented_verified",
                "Post-hoc analysis is not hyperparameter tuning",
            ),
        ],
        "CODE QUALITY": [
            (
                ...
                "src/",
                "implemented_verified",
                "Marker-facing structure documented in README.md",
            ),
            (
                "Configs",
                ...
                "implemented_verified",
                "Five final experiment configs are retained",
            ),
            (
                "Documentation",
                ...
                "complete",
                "J1 manifests remain historical provenance snapshots",
            ),
            (
                "Testing",
                ...
                "tests/; pytest.ini",
                "implemented_verified",
                "Final documentation suite: 108 passed, 0 failed, 0 warnings",
            ),
            (
                "Reproducibility",
                ...
                "Seed-controlled does not imply bitwise-identical retraining",
            ),
            (
                "Test suite",
                ...
                "Final documentation suite: 108 passed, 0 failed, 0 warnings",
                "implemented_verified",
                "Review-package-only tests were removed with their generator",
            ),
            (
                "Requirements",
                ...
                "requirements.txt",
                "implemented_verified",
                "CUDA wheel index remains platform-specific",
            ),
            (
                "Logging",
                ...
                "implemented_verified",
                "Predictions are retained under outputs/predictions/",
            ),
        ],
        "ORAL/VIVA": [
            (
                ...
                "viva_notes.md",
                "retained_final_reference",
                "Concise technical preparation notes; no review-package dependency",
            )
        ],
    }
